...
/**
 * Lower standard (TC39) decorators in a JavaScript module, leaving all other
 * syntax unchanged.
 *
 ...
 * an esbuild target during development. The Vite and Vitest plugins call this
 * from a `transform` hook that runs after Vite has stripped TypeScript.
 *
